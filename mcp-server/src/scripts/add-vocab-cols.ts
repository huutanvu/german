    ...
    columns: [
      {
        ...
        fields: {
          ...
          widgetOptions: JSON.stringify({
            choices: ['noun', 'verb', 'adjective', 'adverb', 'preposition', 'pronoun', 'conjunction', 'phrase']
          })
        }
      },
      {
...
async function run() {
  ...
  console.log('Vocabulary categorization and audio columns created/verified in Grist.');
}
